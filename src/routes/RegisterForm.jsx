                    ...
                    <section className='content_register'>
                        ...
                        <form className='regis_form' onSubmit={handleSubmit}>
                            <div className='name_lastname_content' >
                                <div className="name_input">
                                    <label htmlFor="name">
                                        ...
                                        <span className={validName || !name ? "hide" : "invalid"}> {/* if empty input or validName hide Incorrect */}
                                            Incorrect
                                        </span>
                                    </label>
                                    ...
                                    />
                                    {nameFocus && <Overlay target={nameRef.current} show={!validName} placement="right">
                                        {(props) => (
                                ...
                                <div className="lastname_input">
                                    <label htmlFor="lastName">
                                        ...
                                        <span className={validLastName || !lastName ? "hide" : "invalid"}> {/* if empty input or validName hide Incorrect */}
                                            Incorrect
                                        </span>
                                    </label>
                            ...
                            <div className='address_box'>
                                ...
                                />
                                {addressFocus && <Overlay target={addressRef.current} show={!validAddress} placement="right">
                                    {(props) => (
                            ...
                            <div className='email_box'>
                                ...
                                />
                                {emailFocus && <Overlay target={emailRef.current} show={!validEmail} placement="right">
                                    {(props) => (
                                    <Tooltip id="overlay-example" {...props}>
                            ...
                            <div className='pwdMatch_box'>               
                                ...
                                />
                                {matchFocus && <Overlay target={pwdMatchRef.current} show={!validMatch} placement="right">
                                    {(props) => (
                                    <Tooltip id="overlay-example" {...props}>
